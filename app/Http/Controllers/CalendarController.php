...
{
    private $cleaningServicesRepository;

    public function __construct(
        CleaningServicesRepositoryInterface $cleaningServicesRepository
    )
    {
        $this->cleaningServicesRepository = $cleaningServicesRepository;
    }
    ...
    public function index(Request $request)
    {
        ...
        $cleaning_services = $this->cleaningServicesRepository->all($search);
