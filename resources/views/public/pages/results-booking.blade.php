            ...
            <div class="card">
                ...
                <div class="card-body">
                            ...
                            <tr>
                                <td scope="row">
                                    ...
                                    <div class="row" style="">
                                        ...
                                        <div class="col-sm-9">
                                            {{ $booking->arrival_date }} - {{ $booking->departure_date }} ({{ $booking->nights }}) @ {{ priceFormat($booking->price_per_night) }} USD {{ __('avg. night') }}
                                        </div>
                                    </div>
                                    @if(!$paid)
                                        <div class="row" style="">
                                            <label class="col-sm-12 col-form-label" style="font-size: 12px;color: #5e7180;margin-bottom: 4px;">
                    ...
                    @if(!$paid)
                        ...
                        <form #target="_blank" action="https://www.paypal.com/cgi-bin/webscr" method="post" id="make-payment-form" accept-charset="UTF-8">
                            <div>
                                <input type="hidden" name="cmd" value="_xclick">
                                {{-- QUITAR ESTO CUANDO YA VAYA A FUNCIONAR --}}
                                {{-- <input type="hidden" name="business" value="4VTZ68GP74YXU"> --}}
                                <input type="hidden" name="charset" value="utf-8">
                                <input type="hidden" name="return" value="{{ route('public.thank-you') }}">
                                <input type="hidden" name="currency_code" value="USD">
                                <input type="hidden" name="item_name" value="{{ $property->name }} {{ $booking->arrival_date }} - {{ $booking->departure_date }} | {{ $booking->nights }} Night(s)">
