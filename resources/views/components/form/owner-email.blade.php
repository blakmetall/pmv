...
$payment = $row->amount;
$getComission = ($payment * $row->comission) / 100;
$damageInsurance = $row->damage_insurance;
$total = $payment - $getComission - $damageInsurance;
