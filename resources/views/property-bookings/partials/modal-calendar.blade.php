    ...
    <div class="modal-dialog app-table-file-modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">{{ __('Property') }} {{ __('Availability') }}:
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="btns-container">
                            <a href="#" data-source="{{ $property->id }}" data-year="" data-target="#{{ $modalID }}"
                    ...
                    <div class="card-body">
                        <div class="calendar-container">
                            <div class="app-modal-calendar-container"
                                data-url="{{ route('property-calendar.calendar-modal') }}">
                                ...
                            </div>
                        </div>
                    </div>
